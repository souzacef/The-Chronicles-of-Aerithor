...
function faseFinal(heroi) {
    ...
    console.log("\nAzrak: Finalmente, o herói aparece. Você realmente acredita que pode me deter? Eu, que fui forjadonas\ntrevas e alimentado pelo ódio?\n");
    ...
    batalha(heroi, azrak);
    console.log("Em um momento de descuido de Azrak, você percebe que a hora de agir chegou.\n");
